...
GO
/****** Object:  Table [dbo].[Repartidor]    Script Date: 30/05/2020 05:44:56 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Repartidor]
GO
/****** Object:  Table [dbo].[Recepcionista]    Script Date: 30/05/2020 05:44:56 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Recepcionista]
GO
/****** Object:  Table [dbo].[Mesero]    Script Date: 30/05/2020 05:44:56 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Mesero]
GO
/****** Object:  Table [dbo].[Inspection]    Script Date: 30/05/2020 05:44:56 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Inspection]
GO
/****** Object:  Table [dbo].[Guardia]    Script Date: 30/05/2020 05:44:56 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Guardia]
GO
/****** Object:  Table [dbo].[Conserje]    Script Date: 30/05/2020 05:44:56 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Conserje]
GO
/****** Object:  Table [dbo].[Chef]    Script Date: 30/05/2020 05:44:56 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Chef]
GO
USE [master]
GO
/****** Object:  Database [Restaurantes]    Script Date: 30/05/2020 05:44:56 p. m. ******/
