...
GO
/****** Object:  Table [dbo].[Repartidor]    Script Date: 30/05/2020 07:45:32 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Repartidor]
GO
/****** Object:  Table [dbo].[Recepcionista]    Script Date: 30/05/2020 07:45:32 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Recepcionista]
GO
/****** Object:  Table [dbo].[Mesero]    Script Date: 30/05/2020 07:45:32 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Mesero]
GO
/****** Object:  Table [dbo].[Inspection]    Script Date: 30/05/2020 07:45:32 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Inspection]
GO
/****** Object:  Table [dbo].[Guardia]    Script Date: 30/05/2020 07:45:32 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Guardia]
GO
/****** Object:  Table [dbo].[Conserje]    Script Date: 30/05/2020 07:45:32 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Conserje]
GO
/****** Object:  Table [dbo].[Chef]    Script Date: 30/05/2020 07:45:32 p. m. ******/
DROP TABLE IF EXISTS [dbo].[Chef]
GO
USE [master]
GO
/****** Object:  Database [Restaurantes]    Script Date: 30/05/2020 07:45:32 p. m. ******/
...
GO
INSERT [dbo].[Mesero] ([IdM], [Nombre], [ApellidoP], [ApellidoM], [Edad], [Sexo]) VALUES (N'1', N'Jonatan', N'Guerrero', N'Cantu', 18, N'M')
GO
...
GO
INSERT [dbo].[Mesero] ([IdM], [Nombre], [ApellidoP], [ApellidoM], [Edad], [Sexo]) VALUES (N'2', N'Gabriela', N'Guerrero', N'Cabrera', 36, N'F')
GO
INSERT [dbo].[Mesero] ([IdM], [Nombre], [ApellidoP], [ApellidoM], [Edad], [Sexo]) VALUES (N'3', N'Estafania', N'Rojas', N'Cantu', 28, N'F')
GO
INSERT [dbo].[Mesero] ([IdM], [Nombre], [ApellidoP], [ApellidoM], [Edad], [Sexo]) VALUES (N'4', N'Vicente', N'Martinez', N'Gobea', 18, N'M')
GO
